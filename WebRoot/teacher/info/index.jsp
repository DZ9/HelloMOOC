			...
			<div class="col-md-3 col-md-offset-1">
				<div class="pane-holder info-holder">
					<div class="avatar-holder">
					  <img class="avatar img-circle" src="<%= homePath %>upload/${teacher.photoURL}" data-holder-rendered="true" >
					</div><hr>
					<h6 class="name">${teacher.name}</h6><hr>
					<p><span class="glyphicon glyphicon-envelope"></span>邮箱：${teacher.email}</p>
					<p><span class="glyphicon glyphicon-tag"></span>学校：${teacher.school }</p>
					<p><span class="glyphicon glyphicon-user"></span>简介：${teacher.introduction }</p><hr>
					<a href="<%= homePath%>teacher/edit/teacherEdit?teacher.ID=${teacher.ID}" id="edit-btn" class="btn btn-primary btn-block">修 改</a>
				</div>
			</div>
			<div class="col-md-7">
				<div class="pane-holder course-pane-holder">
					<h6>发布的课程<span class="pane-info">${courses.size() }</span></h6><hr>

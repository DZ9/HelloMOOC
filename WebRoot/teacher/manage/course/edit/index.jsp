	          ...
	          <h6>修改课程</h6>
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="info-pane"><!-- 课程信息 -->
						<div class="info-pane">
	          <form role="form" method="post" action="teacher_updateCourse" enctype="multipart/form-data">
				...
				<input class="hide" type="text" name="course.picURL" value="${course.picURL}">
							...
							<div class="table-responsive">
								<table class="table table-hover" id="video-list">
									...
									<tr data-id="视频ID">
										...
										<td>
											<a href="<%=homePath %>teacher/manage/course/edit/teacher_deleteVideo?video.id=${sessionScope.video.id}" class="manage-remove-btn remove-video-btn" title="删除"><span class="glyphicon glyphicon-remove"></span></a>						
										</td>		
									</tr>
									</s:if>
									</s:iterator>
									...
									<s:iterator id="resource" value="resources">
										<s:if test="#resource!=null">
											<tr data-id="资料ID">
												...
												<td>
													<a href="<%=homePath %>teacher/manage/course/edit/teacher_deleteResource?resource.id=${sessionScope.resource.id}" class="manage-remove-btn remove-resource-btn" title="删除"><span class="glyphicon glyphicon-remove"></span></a>						
												</td>		
											</tr>
										</s:if>
									</s:iterator>
								...
								<table class="table table-hover" id="msg-list">
									...
									<s:iterator id="post" value="posts">
										...
										<tr data-id="通知ID">
											...
											<td>
												<a href="<%=homePath %>teacher/manage/course/edit/teacher_deletePost?post.id=${sessionScope.post.id}" class="manage-remove-btn remove-msg-btn" title="删除"><span class="glyphicon glyphicon-remove"></span></a>							
											</td>
										</tr>
	...
	<div class="modal fade" id="msg-add-modal" tabindex="-1" role="dialog" aria-labelledby="msg-add-title" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<form id="msg-add-form" action="teacher_addPost" method="post">
	      		<div class="form-group">
	...
	<div class="modal fade" id="resource-add-modal" tabindex="-1" role="dialog" aria-labelledby="resource-add-title" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<form id="resource-add-form" method="post" action="teacher_uploadResource" enctype="multipart/form-data">
	...
	<div class="modal fade" id="video-add-modal" tabindex="-1" role="dialog" aria-labelledby="video-add-title" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<form id="video-add-form" action="teacher_uploadVideo" method="post" enctype="multipart/form-data">
	      		<div class="form-group input-holder">
